...
const VALID_PERMISSION_KEYS = (/* unused pure expression or super */ null && ([
    'actions',
    'administration',
    'checks',
    'contents',
...
const VALID_PERMISSION_VALUES = (/* unused pure expression or super */ null && (['read', 'write']));
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        const shouldSetupGitCreds = (0, core_2.getBooleanInput)('setup-git-creds');
        const permissions = (0, core_1.getInput)('permissions');
        (0, core_1.debug)(`permissions: type: ${permissions}, JSON: ${JSON.stringify(permissions)}`);
    });
}
